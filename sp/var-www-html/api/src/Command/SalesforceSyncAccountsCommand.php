...
class SalesforceSyncAccountsCommand extends Command
{
    protected static $defaultName = 'app:salesforce:sync-accounts';
    /**
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $metaData = $this->salesforceService->syncAccount();
